   ...
   <script type="text/javascript" src="<?= site_url('/assets/js/moment-with-locales.min.js'); ?>"></script>
   <script type="text/javascript" src="<?= site_url('/assets/js/bootstrap-datetimepicker.min.js'); ?>"></script>
   <script type="text/javascript" src="<?= site_url('/assets/js/select2.full.min.js'); ?>"></script>
