...
class Locacion_controller extends CI_Controller{
  ...
  public function guardar()
  {
     ...
     $recargo_entrega       = $this->input->post('recargo_entrega');
     $recargo_devolucion    = $this->input->post('recargo_devolucion');
     $recargo_entrega       = $this->input->post('recargo_entrega');
     $recargo_devolucion    = $this->input->post('recargo_devolucion');

     if ( $locacion != null && $recargo_entrega != null && $recargo_devolucion != null)
        {

         $insert = array(
                        'locacion' => $locacion,
                        'recargo_entrega' => $recargo_entrega,
                        'recargo_devolucion' => $recargo_devolucion,
                        'entrega' => $entrega,
