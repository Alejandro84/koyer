...
# Base de datos: koyer
# Tiempo de Generación: 2017-08-16 14:11:33 +0000
# ************************************************************
...
CREATE TABLE `clientes` (
  ...
  `fecha_nacimineto` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `vehiculos` (
  ...
  `id_estado_arriendo` int(2) DEFAULT '1',
  `c_date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `estado` tinyint(1) DEFAULT '1',
...
INSERT INTO `vehiculos` (`id_vehiculo`, `patente`, `id_modelo`, `id_marca`, `id_transmision`, `id_combustible`, `id_categoria`, `id_tarifa`, `id_estado_arriendo`, `c_date`, `estado`)
VALUES
	(1,'BXXD96',8,4,1,1,1,1,1,'2017-08-04 17:10:57',1),
	(2,'BBHK96',13,1,3,2,5,1,1,'2017-08-07 11:22:23',0),
	(3,'VV2365',8,4,1,1,1,1,2,'2017-08-13 18:04:46',1),
	(4,'VV2365',8,4,1,1,1,1,0,'2017-08-13 18:05:11',0),
